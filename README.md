...
```sh
curl --remote-name -O https://raw.githubusercontent.com/dmgerow/sfdc-dev-config/master/mac --remote-name -O https://raw.githubusercontent.com/dmgerow/sfdc-dev-config/master/sfdc && sh mac 2>&1 | tee ~/sfdc-dev-setup.log
```
